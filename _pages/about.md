...
I'm a <img src="{{ '/assets/img/Icon-Vim.svg' | relative_url }}" width="20"/> enthusiast, my lua configuration is available [here](https://github.com/akashsharma02/neovim-config/). I also enjoy mechanical keyboards, and I currently use a custom built keyboard [Sofle Keyboard](projects/sofle-keyboard). Also checkout my partner and my constant support [Tarasha Khurana's](https://www.cs.cmu.edu/~tkhurana/) profile who also currently pursues a Ph.D. in robotics at CMU.
